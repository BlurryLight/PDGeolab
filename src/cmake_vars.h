...
inline std::string ROOT_DIR = "/mnt/SSD/QTC++/PDGeolab";
...
inline std::string BUILD_SYSTEM_VERSION = "5.4.44-1-MANJARO";
inline std::string BUILD_SYSTEM_NAME = "Linux";
inline std::string BUILD_UTC_TIMESTAMP = "2020-07-13T08:46:14Z";
